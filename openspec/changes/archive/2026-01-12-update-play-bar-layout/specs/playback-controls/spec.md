...
- **THEN** a dual-thumb range slider is displayed at the bottom of the viewport
...
The system SHALL support automatic step advancement with play/stop controls in the bottom bar, advancing the range end value.
